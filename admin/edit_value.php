    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li class="active"><!-- active begin -->
                <i class="fa fa-dashboard"></i> Dashboard / Value table
            </li><!-- active finish -->
            ...
            <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <textarea name="value" cols="19" rows="10" class="form-control">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                       ...
                       <div class="col-md-6"><!-- col-md-6 Begin -->
                           <input name="update" value="Update Value" type="submit" class="btn btn-primary form-control">
                       </div><!-- col-md-6 Finish -->
                    </div><!-- form-group Finish -->
...
if(isset($_POST['update'])){
    ...
    $update_value = "update about set value='$value' where about_id='$edit_id'";
    
    $run_value = mysqli_query($con,$update_value);
