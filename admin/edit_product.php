                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input name="product_img" type="file" value="<?php echo $product_img ?>" class="form-control"> <br />
...
if(isset($_POST['update'])){
    ...
    $update_product = "update product set product_name='$product_name',product_img='$product_img',product_desc='$product_desc',icon='$icon' where product_id='$edit_id'";
